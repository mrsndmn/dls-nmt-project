...
По горизонтали головы, по вертикали слои (да, это был трансформер с 2 слоями, потому что его было проще обучить)
...
## todo из идей, которые появились, пока этим занимался:
