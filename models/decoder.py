...
class TransformerDecoderBlock(nn.Module):
    ...
    def __init__(self, hidden_dim: int, key_query_value_dim: int = 64, num_attention_heads=8, feed_forward_hidden_dim: int = 2048, num_heads=8):
        ...
        masked_multihead_attention = MaskedMultiHeadAttention(
            hidden_dim, key_query_value_dim=key_query_value_dim, value_dim=key_query_value_dim, num_heads=num_heads)
